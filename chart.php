...
class NextPay_Chart{
    ...
    public static function stats_page(){
		...
		if ( empty($form) )
			die(__('فرم درخواستی وجود ندارد.','gravityformsnextpay'));
		?>
		<style type="text/css">
			.nextpay_graph_container{clear:both; padding-left:5px; min-width:789px; margin-right:50px;}
			.nextpay_message_container{clear: both; padding-left:5px; text-align:center; padding-top:120px; border: 1px solid #CCC; background-color: #FFF; width:100%; height:200px;}
			.nextpay_summary_container {margin:30px 60px; text-align: center; min-width:740px; margin-left:50px;}
			.nextpay_summary_item {width:180px; height:70px; border-radius:5px; background-color: #FFF; border: 1px solid #CCC; padding:14px 8px; margin:6px 3px 6px 0; display: -moz-inline-stack; display: inline-block; zoom: 1; *display: inline; text-align:center;}
			.nextpay_summary_value {font-size:20px; margin:5px 0;}
			.nextpay_summary_title {height:40px;}
		...
		<div class="wrap">
			<ul class="subsubsub">
				<li><a class="<?php echo (!rgget("tab") || rgget("tab") == "today") ? "current" : "" ?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>"><?php _e("امروز", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "yesterday"   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=yesterday"><?php _e("دیروز", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "last7days"   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last7days"><?php _e("هفت روز گذشته", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "thisweek"    ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=thisweek"><?php _e("هفته جاری", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "last30days"  ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last30days"><?php _e("30 روز گذشته", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "thismonth"   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=thismonth"><?php _e("ماه جاری", "gravityformsnextpay"); ?></a>|</li>
				<li><a class="<?php echo rgget("tab") == "lastmonth"   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=lastmonth"><?php _e("ماه قبل", "gravityformsnextpay"); ?></a>|</li>
				<li><a class="<?php echo rgget("tab") == "last2month"  ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last2month"><?php _e("2 ماه اخیر", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "last3month"  ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last3month"><?php _e("3 ماه اخیر", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "last6month"  ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last6month"><?php _e("6 ماه اخیر", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "last9month"  ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last9month"><?php _e("9 ماه اخیر", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "last12month" ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last12month"><?php _e("یک سال اخیر", "gravityformsnextpay"); ?></a> | </li>
				<li><a class="<?php echo rgget("tab") == "spring" 	   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=spring"><?php _e("بهار", "gravityformsnextpay"); ?></a>|</li>
				<li><a class="<?php echo rgget("tab") == "summer" 	   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=summer"><?php _e("تابستان", "gravityformsnextpay"); ?></a>|</li>
				<li><a class="<?php echo rgget("tab") == "fall"        ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=fall"><?php _e("پاییز", "gravityformsnextpay"); ?></a>|</li>
				<li><a class="<?php echo rgget("tab") == "winter" 	   ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=winter"><?php _e("زمستان", "gravityformsnextpay"); ?></a>|</li>
				<li><a class="<?php echo rgget("tab") == "thisyear"    ? "current" : ""?>" href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=thisyear"><?php _e("امسال", "gravityformsnextpay"); ?></a></li>      
				<br/><br/>
				<form method="post" action="?page=gf_nextpay&view=stats&id=<?php echo rgget("id") ?>&tab=selection">
					<span><?php _e('از تاریخ', 'gravityformsnextpay') ?></span>
					<input type="text" name="min"  class="datepicker" value="<?php echo rgpost('min'); ?>" autocomplete="off"/>
					<span style="margin-right:15px"><?php _e('تا تاریخ', 'gravityformsnextpay') ?></span>
					<input type="text" name="max"  class="datepicker"  value="<?php echo rgpost('max'); ?>" autocomplete="off"/>
					<input type="submit" class="button-primary button" name="submit" value="<?php _e('انتخاب', 'gravityformsnextpay') ?>"><br>
				</form>
			</ul>
			...
			switch(rgget("tab")){
				...
				case "spring" :
					...
					$chart_info_nextpay = self::season_chart_info($form_id,3,1);
				...
				case "summer" :
					...
					$chart_info_nextpay = self::season_chart_info($form_id,3,2);
				...
				case "fall" :
					...
					$chart_info_nextpay = self::season_chart_info($form_id,3,3);
				...
				case "winter" :
					...
					$chart_info_nextpay = self::season_chart_info($form_id,3,4);
				...
				case "thisyear" :
					...
					$chart_info_nextpay = self::yearly_chart_info($form_id,3);
				...
				case "last7days" :
					...
					$chart_info_nextpay = self::lastxdays_chart_info($form_id,3,7);
				...
				case "thisweek" :
					...
					$chart_info_nextpay = self::thisweek_chart_info($form_id,3);
				...
				case "last30days" :
					...
					$chart_info_nextpay = self::lastxdays_chart_info($form_id,3,30);
				...
				case "thismonth" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,1);
				...
				case "lastmonth" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,2);
				...
				case "last2month" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,60);
				...
				case "last3month" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,3);
				...
				case "last6month" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,6);
				...
				case "last9month" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,9);
				...
				case "last12month" :
					...
					$chart_info_nextpay = self::targetmdays_chart_info($form_id,3,12);
				...
				case "selection" :
					...
					$chart_info_nextpay = self::selection_chart_info($form_id,3,rgpost('min'),rgpost('max'));
				...
				case "yesterday" :
					...
					$chart_info_nextpay = self::tyday_chart_info($form_id,3,2);
				...
				default :
					...
					$chart_info_nextpay = self::tyday_chart_info($form_id,3,1);
			...
			<div class="clear"></div>
			<h2><?php _e(" درآمد از درگاه نکست پی برای فرمِ ", "gravityformsnextpay") ?><?php echo '"'.$form["title"].'"'; ?></h2>
			<form method="post" action="">
				<?php if ( empty($chart_info["series"]) ){ ?>
					<div class="nextpay_message_container"><?php _e("موردی یافت نشد . ", "gravityformsnextpay") ?></div>
				<?php } else{ ?>
				<div class="nextpay_graph_container">
					<div id="graph_placeholder" style="width:100%;height:300px;"></div>
				</div>
				<?php
				}
				
				$sales_label = __("تعداد کل پرداخت های  نکست پی این فرم", "gravityformsnextpay");
				
				$transaction_totals = NextPay_GData::get_transaction_totals($form_id);
				...
				?>
				<div class="nextpay_summary_container">
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php _e('جمع پرداخت های  نکست پی این فرم', 'gravityformsnextpay') ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue),'fa') ?></div>
					</div>
					
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info["revenue_label"]?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info["revenue"],'fa') ?></div>
					</div>
			
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info["mid_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info["mid"],'fa') ?></div>
					</div>
			
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $sales_label?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($total_sales,'fa') ?></div>
					</div>
            
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info["sales_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info["sales"],'fa') ?></div>
					</div>
			
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info["midt_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info["midt"],'fa') ?></div>
					</div>
		...
		<hr>
		<div class="clear"></div>
		<h2><?php _e(" درآمد از همه روش ها برای فرمِ ", "gravityformsnextpay") ?><?php echo '"'.$form["title"].'"'; ?></h2>
        <form method="post" action="">
			...
			$sales_label = __("تعداد کل پرداخت های  همه روش های این فرم", "gravityformsnextpay");
			
			$transaction_totals = NextPay_GData::get_transaction_totals_gateways($form_id);
			$total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
			$total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
			?>
			...
			<div class="nextpay_summary_container">
				...
				<div class="nextpay_summary_item">
					<div class="nextpay_summary_title"><?php _e("جمع پرداخت های  همه روشهای این فرم", "gravityformsnextpay")?></div>
					<div class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue),'fa') ?></div>
				</div>
                    
				<div class="nextpay_summary_item">
					<div class="nextpay_summary_title"><?php echo $chart_info_gateways["revenue_label"]?></div>
					<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["revenue"],'fa') ?></div>
				</div>
					
				<div class="nextpay_summary_item">
					<div class="nextpay_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
					<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["mid"],'fa') ?></div>
				</div>
				...
				<div class="nextpay_summary_item">
					<div class="nextpay_summary_title"><?php echo $chart_info_gateways["sales_label"] ?></div>
					<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["sales"],'fa') ?></div>
				</div>
					
				<div class="nextpay_summary_item">
					<div class="nextpay_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
					<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["midt"],'fa') ?></div>
				</div>
		...
		<hr>
		<div class="clear"></div>
			<h2><?php _e(" کل درآمد های نکست پی", "gravityformsnextpay") ?></h2>
            <form method="post" action="">
                <?php if(!$chart_info_nextpay["series"]){ ?>
                    <div class="nextpay_message_container"><?php _e("موردی یافت نشد . ", "gravityformsnextpay") ?></div>
				<?php } else { ?>
					<div class="nextpay_graph_container">
				...
				$sales_label = __("تعداد کل پرداخت های درگاه نکست پی", "gravityformsnextpay");
				
				$transaction_totals = NextPay_GData::get_transaction_totals_nextpay();
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                <div class="nextpay_summary_container">
                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php _e("جمع پرداخت های  همه فرمهای نکست پی", "gravityformsnextpay")?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue),'fa') ?></div>
                    </div>
                    
					<div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_nextpay["revenue_label"]?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_nextpay["revenue"],'fa') ?></div>
                    </div>
										
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info_nextpay["mid_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_nextpay["mid"],'fa') ?></div>
					</div>
					...
					<div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_nextpay["sales_label"] ?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_nextpay["sales"],'fa') ?></div>
                    </div>
					
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info_nextpay["midt_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_nextpay["midt"],'fa') ?></div>
					</div>
                </div>
        </form>
		<hr>
		<div class="clear"></div>
		 <h2><?php _e(" کل درآمد های سایت ( همه روش ها برای همه فرم ها)", "gravityformsnextpay") ?></h2>
            <form method="post" action="">
				...
				$sales_label = __("تعداد کل پرداخت های همه فرمهای سایت", "gravityformsnextpay");
				
				$transaction_totals = NextPay_GData::get_transaction_totals_site();
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                <div class="nextpay_summary_container">
                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php _e("جمع کل پرداخت های همه فرمهای سایت", "gravityformsnextpay")?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue),'fa') ?></div>
                    </div>
                    
					<div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_site["revenue_label"]?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["revenue"],'fa') ?></div>
                    </div>
					
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info_site["mid_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["mid"],'fa') ?></div>
					</div>
					<div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $sales_label?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num($total_sales,'fa') ?></div>
					...
					<div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_site["sales_label"] ?></div>
                        <div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["sales"],'fa') ?></div>
                    </div>
					
					<div class="nextpay_summary_item">
						<div class="nextpay_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
						<div class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["midt"],'fa') ?></div>
					</div>
                </div>
            </form>
		</div>
		<script type="text/javascript">
			var nextpay_graph_tooltips = <?php echo GF_tr_num($chart_info["tooltips"],'fa') ?>;
			...
			function startShowTooltip(item){
				if (item) {
					if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
						...
						jQuery("#nextpay_graph_tooltip").remove();
                        var x = item.datapoint[0].toFixed(2),
                        y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, nextpay_graph_tooltips[item.dataIndex]);
					}
				}
				else {
					jQuery("#nextpay_graph_tooltip").remove();
            ...
            var nextpay_graph_tooltip1s1 = <?php echo GF_tr_num($chart_info_nextpay["tooltips"],'fa') ?>;
            jQuery.plot(jQuery("#graph_placeholder1"), [<?php echo $chart_info_nextpay["series"] ?>], <?php echo $chart_info["options"] ?>);
			jQuery(window).resize(function(){
				jQuery.plot(jQuery("#graph_placeholder1"), [<?php echo $chart_info_nextpay["series"] ?>], <?php echo $chart_info["options"] ?>);
			});
            var previousPoint = null;
            ...
            function startShowTooltip1(item){
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        var x = item.datapoint[0].toFixed(2),
                        y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, nextpay_graph_tooltip1s1[item.dataIndex]);
					}
                }
				else {
					jQuery("#nextpay_graph_tooltip").remove();
			...
			var nextpay_graph_tooltip2s2 = <?php echo GF_tr_num($chart_info_gateways["tooltips"],'fa') ?>;
			...
			function startShowTooltip2(item){
				if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        var x = item.datapoint[0].toFixed(2),
                        y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, nextpay_graph_tooltip2s2[item.dataIndex]);
					}
                }
				else {
					jQuery("#nextpay_graph_tooltip").remove();
			...
			var nextpay_graph_tooltip3s3 = <?php echo GF_tr_num($chart_info_site["tooltips"],'fa') ?>;
			...
			function startShowTooltip3(item){
                if (item) {
					if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        var x = item.datapoint[0].toFixed(2),
                        y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, nextpay_graph_tooltip3s3[item.dataIndex]);
					}
				}
				else {
					jQuery("#nextpay_graph_tooltip").remove();
			...
			function showTooltip(x, y, contents) {
				jQuery('<div id="nextpay_graph_tooltip">' + contents + '<div class="tooltip_tip1"></div></div>').css( {
					position: 'absolute',
					display: 'none',
					opacity: 1,
					width:'150px',
	...
	public static function lastxdays_chart_info($form_id,$chart,$x){
		...
		if ( $chart == 1 ) {
			...
			$t = __( 'نکست پی این فرم', 'gravityformsnextpay');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '" . $tz_offset . "') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        ...
                                        WHERE form_id={$form_id} AND l.status='active' AND l.is_fulfilled=1 AND l.payment_method='nextpay'
                                        GROUP BY date(date)
		...
		if ($chart==2) {
			...
			$t= __( 'همه روشهای این فرم', 'gravityformsnextpay');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '" . $tz_offset . "') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
		...
		if ($chart==3) {
			$c = 'orang'; $dt="}";
			$t= __( "همه فرمهای نکست پی", 'gravityformsnextpay');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '" . $tz_offset . "') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
                                        WHERE l.status='active' AND l.is_fulfilled=1 AND l.payment_method='nextpay'
                                        GROUP BY date(date)
                                        ORDER BY payment_date desc");
		}
		...
		if ($chart==4) {
			...
			$t= __( "همه فرمهای سایت", 'gravityformsnextpay');
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '" . $tz_offset . "') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
		...
		if(!empty($results)){
            ...
            foreach($results as $result){
				...
				$sales_line = "<div class='nextpay_tooltip_sales'><span class='nextpay_tooltip_heading'>" . __("تعداد پرداخت ", "gravityformsnextpay") . ": </span><span class='nextpay_tooltip_value'>" . $result->new_sales . "</span></div>";

                $tooltips .= "\"<div class='tooltipbox_".$c."'><div class='nextpay_tooltip_date'>" . $timeX_tooltips . "</div>{$sales_line}<div class='nextpay_tooltip_revenue'><span class='nextpay_tooltip_heading'>" . __("پرداختی", "gravityformsnextpay") . ": </span><span class='nextpay_tooltip_value'>" . GFCommon::to_money($result->amount_sold) . "</span></div></div>\",";
            }
		...
		if ($x==7){
			$n =  __( '7 روز', 'gravityformsnextpay');
			$mid = 7;
		}
		if ($x==30) {
			$n = __( '30 روز', 'gravityformsnextpay');
			$mid = 30;
		}

		$sales_label = sprintf( __("تعداد پرداخت های %s گذشته %s" , 'gravityformsnextpay' ) , $n , $t );

        $midt = $mid ? $sales_week/$mid : 0;
		$mid = ($mid ? GFCommon::to_money($revenue_week/$mid) : 0 ). __("در روز" , 'gravityformsnextpay' );
		$midt= number_format($midt, 3, '.', '') . __("در روز" , 'gravityformsnextpay' );
		$midt_label = sprintf( __("میانگین تعداد پرداخت های %s گذشته %s" , 'gravityformsnextpay' ) , $n , $t );
		$mid_label = sprintf( __("میانگین پرداخت های %s گذشته %s" , 'gravityformsnextpay' ) , $n , $t );
		$revenue_week = GFCommon::to_money($revenue_week);
		$revenue_label = sprintf( __("جمع پرداخت های %s گذشته %s" , 'gravityformsnextpay' ) , $n , $t );
	...
	public static function thisweek_chart_info($form_id,$chart){
		...
		if ($chart==4) {
			$c = 'red';
			$dt="points: { symbol: 'triangle', fillColor: '#AA4643' }, color: '#AA4643'}";
			$t = __("همه فرم های سایت" , 'gravityformsnextpay' );
			$results = $wpdb->get_results("SELECT CONVERT_TZ(l.payment_date, '+00:00', '" . $tz_offset . "') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
                                        WHERE l.status='active' AND l.is_fulfilled=1
                                        GROUP BY date(date)
		...
		$sales_label = __( "تعداد پرداخت های  این هفته " , 'gravityformsnextpay' ).$t;

		$midt = $sales_week/7;
		$midt= ($midt ? number_format($midt, 3, '.', '') : 0 ).__(" در روز" , 'gravityformsnextpay' );
		$midt_label = __( "میانگین تعداد پرداخت های  این هفته " , 'gravityformsnextpay' ).$t;
		$mid = GFCommon::to_money($revenue_week/7).__(" در روز" , 'gravityformsnextpay' );
		$mid_label = __("میانگین پرداخت های این هفته " , 'gravityformsnextpay' ).$t;
		$revenue_week = GFCommon::to_money($revenue_week);
		$revenue_label = __("جمع پرداخت های  این هفته " , 'gravityformsnextpay' ).$t;
	...
	public static function targetmdays_chart_info($form_id,$chart,$xmonth){
        ...
        if(!empty($results)){
			...
			if ($xmonth==1 || $xmonth==2) {
				...
				$n = $n.__(" ماه", "gravityformsnextpay");
			}
			if ( $xmonth==60 || $xmonth==3 || $xmonth==6 || $xmonth==9 || $xmonth==12 ){
				...
				if ($xmonth == 60)
					$n = 2;
				$n = $n.__(" ماه اخیر", "gravityformsnextpay");

				if ($xmonth == 12)
					$n = __(" یکسال اخیر", "gravityformsnextpay");
			}
		...
		if ( $xmonth==60 || $xmonth==3 || $xmonth==6 || $xmonth==9 || $xmonth==12 ){
			...
			if ($xmonth == 12)
				$n = __( 'یک سال اخیر' , 'gravityformsnextpay' );
		}

		$sales_label = __( 'تعداد پرداخت های  ' , 'gravityformsnextpay' ).$n. ' '.$t;
		...
		$midt= number_format($midt, 3, '.', '').__( " در روز" , 'gravityformsnextpay' );
		$midt_label = __( 'میانگین تعداد پرداخت های ' , 'gravityformsnextpay' ).$n. ' '.$t;
		$mid = ( $midd ? GFCommon::to_money($revenue_thistday/$midd) : 0 ).__( " در روز" , 'gravityformsnextpay' );
		$mid_label = __( 'میانگین پرداخت های ' , 'gravityformsnextpay' ).$n. ' '.$t;
		$revenue_label = __( 'جمع پرداخت های  ' , 'gravityformsnextpay' ).$n. ' '.$t;
	...
	public static function tyday_chart_info($form_id,$chart,$day){
		...
		$date = new DateTime($today);
		if ($day==1) {
			$n = __( "امروز" , 'gravityformsnextpay' );
			$baze = date('m d , Y',$tday);
			$ty = date('Ymd',$tday);
		}
		else if ($day==2) {
			$n = __( "دیروز" , 'gravityformsnextpay' );
			$date->sub(new DateInterval('P1DT0H0M'));
		...
		$midt = $sales_today/24;
		$midt= number_format($midt, 3, '.', '').__(" در ساعت", "gravityformsnextpay");
		$midt_label = __( "میانگین تعداد پرداخت های ", "gravityformsnextpay").$n." ".$t;
		$mid = GFCommon::to_money($revenue_today/24).__(" در ساعت", "gravityformsnextpay");
		$mid_label = __( "میانگین پرداخت های ", "gravityformsnextpay").$n." ".$t;
	...
	public static function yearly_chart_info($form_id,$chart){
		...
		$sales_label = __("تعداد پرداخت های امسال ", "gravityformsnextpay").$t;
		...
		$midt= number_format($midt, 3, '.', '').__(" در روز", "gravityformsnextpay");
		$midt_label = __("میانگین تعداد پرداخت های امسال ", "gravityformsnextpay").$t;
		$mid = ( $midd ? GFCommon::to_money($revenue_yearly/$midd) : 0 ).__(" در روز", "gravityformsnextpay");
		$mid_label = __("میانگین پرداخت های امسال ", "gravityformsnextpay").$t;
		$revenue_yearly = GFCommon::to_money($revenue_yearly);
		$revenue_label = __("جمع پرداخت های امسال ", "gravityformsnextpay").$t;
	...
	public static function season_chart_info($form_id,$chart,$season){
		...
		if ($season==2){
			$n=__( 'تابستان' , 'gravityformsnextpay' );
			$ebtda = $avalesal_t;
		...
		if ($season==3){
			$n= __( 'پاییز' , 'gravityformsnextpay' );
			$ebtda = $avalesal_t;
		...
		if ($season==4){
			$n= __( 'زمستان' , 'gravityformsnextpay' );
			$ebtda = $avalesal_t;
		...
		$midt= ($midt ? number_format($midt, 3, '.', '') : 0 ).__( " در روز" , 'gravityformsnextpay' );
		$midt_label = __( "میانگین تعداد پرداخت های  " , 'gravityformsnextpay' ).$n ." ".$t;
		$mid = ($midd ? GFCommon::to_money($revenue_season/$midd) : 0).__( " در روز" , 'gravityformsnextpay' );
		$mid_label = __( "میانگین پرداخت های  " , 'gravityformsnextpay' ).$n ." ".$t;
		$revenue_label = __( "جمع پرداخت های  " , 'gravityformsnextpay' ).$n ." ".$t;
	...
	public static function selection_chart_info($form_id,$chart,$min,$max){
		...
		$sales_label = __( "تعداد پرداخت های بازه انتخابی " , 'gravityformsnextpay' ).$t;

		$midt = $midd ? $sales_today/$midd : 0;
		$midt= number_format($midt, 3, '.', '').__( " در روز" , 'gravityformsnextpay' );
		$midt_label = __( "میانگین تعداد پرداخت های  " , 'gravityformsnextpay' ).$t."";
		$mid = ( $midd ? GFCommon::to_money($revenue_today/$midd) : 0 ).__( " در روز" , 'gravityformsnextpay' );
		$mid_label = __( "میانگین پرداخت های  " , 'gravityformsnextpay' ).$t."";
		$revenue_today = GFCommon::to_money($revenue_today);
		$revenue_label = __( "جمع پرداخت های بازه انتخابی " , 'gravityformsnextpay' ).$t;
