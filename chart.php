...
class NextPay_Chart
{
    ...
    public static function stats_page()
    {
        ...
        if (!empty($_POST))
            check_admin_referer("search", "gf_nextpay_chart");
        ...
        <style type="text/css">
            ...
            .nextpay_summary_value {
                font-size: 20px;
                margin: 5px 0;
            }

            .nextpay_summary_title {
                height: 40px;
            }
        ...
        <script type="text/javascript"
                src="<?php echo GFParsi::get_base_url() ?>/assets/js/shamsi_chart.js"></script>
        <script type="text/javascript">
        ...
        <div class="wrap">
            <ul class="subsubsub">
                <li><a class="<?php echo (!rgget("tab") || rgget("tab") == "today") ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>"><?php _e("امروز", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "yesterday" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=yesterday"><?php _e("دیروز", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last7days" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last7days"><?php _e("هفت روز گذشته", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "thisweek" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=thisweek"><?php _e("هفته جاری", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last30days" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last30days"><?php _e("30 روز گذشته", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "thismonth" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=thismonth"><?php _e("ماه جاری", "gravityformsnextpay"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "lastmonth" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=lastmonth"><?php _e("ماه قبل", "gravityformsnextpay"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "last2month" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last2month"><?php _e("2 ماه اخیر", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last3month" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last3month"><?php _e("3 ماه اخیر", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last6month" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last6month"><?php _e("6 ماه اخیر", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last9month" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last9month"><?php _e("9 ماه اخیر", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "last12month" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=last12month"><?php _e("یک سال اخیر", "gravityformsnextpay"); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget("tab") == "spring" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=spring"><?php _e("بهار", "gravityformsnextpay"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "summer" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=summer"><?php _e("تابستان", "gravityformsnextpay"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "fall" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=fall"><?php _e("پاییز", "gravityformsnextpay"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "winter" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=winter"><?php _e("زمستان", "gravityformsnextpay"); ?></a>|
                </li>
                <li><a class="<?php echo rgget("tab") == "thisyear" ? "current" : "" ?>"
                       href="?page=gf_nextpay&view=stats&id=<?php echo rgget('id') ?>&tab=thisyear"><?php _e("امسال", "gravityformsnextpay"); ?></a>
                </li>
                <br/><br/>
                <form method="post"
                      action="?page=gf_nextpay&view=stats&id=<?php echo rgget("id") ?>&tab=selection"><?php wp_nonce_field("search", "gf_nextpay_chart") ?>
                    ...
                    <input type="submit" class="button-primary button" name="submit"
                           value="<?php _e('انتخاب', 'gravityformsnextpay') ?>"><br>
                </form>
            </ul>
            ...
            <div>
                <?php if (empty($chart_info["series"])) { ?>
                    <div
                        class="nextpay_message_container"><?php _e("موردی یافت نشد . ", "gravityformsnextpay") ?></div>
                <?php } else { ?>
                ...
                $transaction_totals = GFNextPayData::get_transaction_totals($form_id);
                ...
                <div class="nextpay_summary_container">
                    <div class="nextpay_summary_item">
                        <div
                            class="nextpay_summary_title"><?php _e('جمع پرداخت های  نکست پی این فرم', 'gravityformsnextpay') ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>
            ...
            <div>
                ...
                $transaction_totals = GFNextPayData::get_transaction_totals_gateways($form_id);
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                ...
                <div class="nextpay_summary_container">
                    ...
                    <div class="nextpay_summary_item">
                        <div
                            class="nextpay_summary_title"><?php _e("جمع پرداخت های  همه روشهای این فرم", "gravityformsnextpay") ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>
                    ...
                    <div class="nextpay_summary_item">
                        ...
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["revenue"], 'fa') ?></div>
                    </div>

                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["mid"], 'fa') ?></div>
                    </div>
                    ...
                    <div class="nextpay_summary_item">
                        ...
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["sales"], 'fa') ?></div>
                    </div>

                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_gateways["midt"], 'fa') ?></div>
                    </div>
            ...
            <div>
                ...
                $transaction_totals = GFNextPayData::get_transaction_totals_nextpay();
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                <div class="nextpay_summary_container">
                    <div class="nextpay_summary_item">
                        <div
                            class="nextpay_summary_title"><?php _e("جمع پرداخت های  همه فرمهای نکست پی", "gravityformsnextpay") ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>

                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_hannan["revenue_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_hannan["revenue"], 'fa') ?></div>
                    </div>

                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_hannan["mid_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_hannan["mid"], 'fa') ?></div>
                    </div>
                    ...
                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_hannan["sales_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_hannan["sales"], 'fa') ?></div>
                    </div>

                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_hannan["midt_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_hannan["midt"], 'fa') ?></div>
                    </div>
                </div>
            </div>
            <hr>
            ...
            <div>
                ...
                $transaction_totals = GFNextPayData::get_transaction_totals_site();
                $total_sales = empty($transaction_totals["active"]["transactions"]) ? 0 : $transaction_totals["active"]["transactions"];
                $total_revenue = empty($transaction_totals["active"]["revenue"]) ? 0 : $transaction_totals["active"]["revenue"];
                ?>
                <div class="nextpay_summary_container">
                    <div class="nextpay_summary_item">
                        <div
                            class="nextpay_summary_title"><?php _e("جمع کل پرداخت های همه فرمهای سایت", "gravityformsnextpay") ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num(GFCommon::to_money($total_revenue), 'fa') ?></div>
                    </div>
                    ...
                    <div class="nextpay_summary_item">
                        ...
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["revenue"], 'fa') ?></div>
                    </div>
                    ...
                    <div class="nextpay_summary_item">
                        ...
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["sales"], 'fa') ?></div>
                    </div>

                    <div class="nextpay_summary_item">
                        <div class="nextpay_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
                        <div
                            class="nextpay_summary_value"><?php echo GF_tr_num($chart_info_site["midt"], 'fa') ?></div>
                    </div>
                </div>
            </div>
        </div>
        <script type="text/javascript">
            ...
            var nextpay_graph_tooltip1s1 = <?php echo GF_tr_num($chart_info_hannan["tooltips"], 'fa') ?>;
    ...
    public static function lastxdays_chart_info($form_id, $chart, $x)
    {
        ...
        global $wpdb;
        $tz = GFParsi::get_mysql_tz_offset();
